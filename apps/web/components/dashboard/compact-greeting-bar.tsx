...
export function CompactGreetingBar({
  ...
  return (
    <div className="sticky top-0 z-10 flex items-center justify-between gap-3 rounded-2xl border border-border/60 bg-background/95 px-4 py-2.5 shadow-sm backdrop-blur-sm sm:px-5">
