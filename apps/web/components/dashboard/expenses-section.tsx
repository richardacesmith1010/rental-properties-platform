  ...
  return (
    <div id="expenses" className="space-y-4">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader><CardTitle>Property P&amp;L</CardTitle></CardHeader>
          <CardContent className="space-y-4">
            {selectedSummary ? (
              <>
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2"><p className="text-[11px] uppercase tracking-wide text-zinc-500">Income</p><p className="text-lg font-semibold text-emerald-700">{formatCurrency(selectedSummary.incomeCents)}</p></div>
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2"><p className="text-[11px] uppercase tracking-wide text-zinc-500">Expenses</p><p className="text-lg font-semibold text-rose-700">{formatCurrency(selectedSummary.expenseCents)}</p></div>
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2"><p className="text-[11px] uppercase tracking-wide text-zinc-500">Net Cashflow</p><p className="text-lg font-semibold text-violet-700">{formatCurrency(selectedSummary.netCents)}</p></div>
                </div>
                <div>
