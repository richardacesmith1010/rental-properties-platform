...
export function LandingPage() {
  ...
  return (
    <main
      id="main-content"
      className="marketing-dark-cards mx-auto flex w-full max-w-7xl flex-col gap-20 px-6 pb-20 pt-10 md:px-10"
    >
      <AnimateOnScroll>
        <header className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-5 py-4 backdrop-blur">
          <p className="text-lg font-semibold leading-none tracking-tight text-violet-100">Domus</p>
          <Link
            href="/login"
            className="inline-flex min-h-10 items-center gap-2 rounded-xl border border-violet-300/30 bg-violet-500/20 px-4 py-2 text-sm font-medium text-violet-100 transition hover:bg-violet-500/30"
